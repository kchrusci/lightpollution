...
```{r}
subset_lm <- lm(sqm~bs(viirs_2015_5_mean, knots=5, degree = 1), data=lp_data)
#subset_lm <- lm(sqm~bs(viirs_2015_1_mean, knots=2, degree = 3) + bs(viirs_2015_5_mean, knots=2, degree = 3) + bs(viirs_2015_20_mean, knots=2, degree = 3), data=lp_data)
...
ggplot(lp_data, aes(x=viirs_2015_5_mean, sqm)) + geom_point() + geom_smooth(method = "lm",formula = y~bs(x, knots=5, degree = 1))
